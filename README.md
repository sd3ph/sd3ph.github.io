...
<head>
    ...
    <style>
        ...
        /* --- PLAYGROUND: PHYSICS RESEARCH EXPLORER STYLES --- */
        /* Scoped styles with 'pre-' prefix to avoid conflicts */
        .pre-container-inner {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            border-radius: 12px;
            padding: 20px;
        ...
        .pre-topic-checkbox:checked + .pre-topic-label strong {
            color: white;
        }

        .pre-query-section { margin-bottom: 30px; }
        ...
        .pre-btn-primary:hover:not(:disabled) {
...
<body>
        ...
        <div id="playground" class="page-content">
            <div class="pre-container-inner">
                <div class="pre-header">
                    ...
                    <p>Generate innovative research ideas using Gemini 1.0 Pro</p>
                </div>

                <div class="pre-research-builder">
                    <div class="pre-physics-core">
                        <p>✨ <strong>Physics as the Foundation:</strong> Select domains below to combine with physics principles.</p>
                    </div>

                    <!-- API Key Section -->
                    <div class="pre-api-section">
                        <label style="font-weight: 600; display: block; margin-bottom: 5px;">Google Gemini API Key:</label>
                        <input type="password" id="apiKey" class="pre-query-input" placeholder="Paste your API key here (starts with AIza...)" />
                        <small style="color: #666;">Don't have a key? <a href="https://aistudio.google.com/app/apikey" target="_blank" style="color: #667eea;">Get a free one here</a>.</small>
                    </div>
                    ...
                    <div class="pre-query-section">
                        ...
                        <input type="text" class="pre-query-input" id="researchQuery" placeholder="E.g., 'renewable energy', 'cancer treatment', 'ancient architecture'...">
                    </div>
    ...
    <script>
        ...
        async function generateIdeas() {
            ...
            try {
                ...
                if (apiKey) {
                    ...
                    messageBox.innerHTML = '<div class="pre-error-message">⚠️ No API Key detected. Showing sample offline results.</div>';
        ...
        async function callGeminiAPI(topics, query, apiKey) {
            ...
            // Using Gemini 1.0 Pro (Standard free tier model)
        ...
        function generateLocalIdeas() {
            return [
                {
                    title: 'Quantum Entanglement Sensors',
                    description: 'Utilizing quantum mechanical entanglement to create ultra-sensitive sensors for detecting minute chemical changes. Physics meets Chemistry for next-gen diagnostics.',
                    domains: 'Physics, Chemistry',
                    impact: 'High'
                },
                {
                    title: 'Bio-Mimetic Aerodynamics',
                    description: 'Studying the fluid dynamics of bird flight to engineer more efficient drone propellers. Combines classical mechanics with biological evolution.',
                    domains: 'Physics, Biology, Engineering',
                    impact: 'Medium'
                },
                {
                    title: 'Thermodynamic Data Storage',
                    description: 'Exploring entropy-based coding for high-density data storage systems using phase-change materials.',
                    domains: 'Physics, Technology',
                    impact: 'High'
                },
                {
                    title: 'Nano-fluidic Drug Delivery',
                    description: 'Applying fluid dynamics at the nanoscale to precisely target drug delivery within the human body, minimizing side effects.',
                    domains: 'Physics, Medical Science',
                    impact: 'High'
                }
            ];
        }
