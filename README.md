    ...
    <div class="container">
        ...
        <div id="about" class="page-content">
            ...
            <div class="section">
                ...
                <p><strong>Assistant Professor (Sr. Gd.), Department of Artificial Intelligence</p>
                </strong>Joint Coordinator (Academic), B.Tech Programme (AI-Quantum Technology), School of AI<span class="date">(Since 03/2025)<br>Amrita Vishwa Vidyapeetham, Coimbatore HQ<br></span></p>
